...
const generateAccessToken = (author) => jwt.sign(author, ACCESS_TOKEN_SECRET ,{expiresIn: '1200s'});

const generateRefreshToken = (author) => jwt.sign(author, REFRESH_TOKEN_SECRET ,{expiresIn: '1200s'});
